...
function installAll {
    ...
    winget install --id=7zip.7zip -e  ; winget install --id=Adobe.Acrobat.Reader.32-bit -e  ; winget install --id=Git.Git -e  ; winget install --id=JanDeDobbeleer.OhMyPosh -e  ; winget install --id=JohnMacFarlane.Pandoc -e  ; winget install --id=Ombrelin.PandocGui -e  ; winget install --id=Microsoft.dotnet -e  ; winget install --id=Microsoft.PowerShell -e  ; winget install --id=Microsoft.PowerToys -e  ; winget install --id=Microsoft.WindowsTerminal -e  ; winget install --id=Notepad++.Notepad++ -e  ; winget install --id=VideoLAN.VLC -e  ; winget install --id=Discord.Discord -e  ; winget install --id=MiKTeX.MiKTeX -e  ; winget install --id=TeXstudio.TeXstudio -e  ; winget install --id=OBSProject.OBSStudio -e  ; winget install --id=Spotify.Spotify -e  ; winget install --id=VB-Audio.VoiceMeeterPotato -e  ; winget install --id=Mozilla.Thunderbird -e  ; winget install --id=DigitalScholar.Zotero -e  ; winget install --id=Microsoft.VisualStudio.2022.Community -e  ; winget install --id=Anki.Anki -e  ; winget install --id=MilosParipovic.OneCommander -e  ; winget install --id=Valve.Steam -e  ; winget install --id=voidtools.Everything -e  ; winget install --id=stnkl.EverythingToolbar -e  ; winget install --id=SamHocevar.WinCompose -e 
}
